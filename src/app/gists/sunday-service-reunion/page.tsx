        ...
        <div className="bg-white rounded-2xl shadow-xl p-8 md:p-12">
          ...
          <div className="border-t pt-8 mt-8">
            ...
            <div className="flex flex-wrap gap-4">
              <button
                onClick={() => {
                  const text = "Check out this amazing DLSO reunion story: One Photo, Endless Joy: Our Sunday Service Reunion Story";
              ...
              <button
                onClick={() => {
                  const text = "Check out this heartwarming DLSO reunion story!";
                  const url = window.location.href;
                  window.open(`https://twitter.com/intent/tweet?text=${encodeURIComponent(text)}&url=${encodeURIComponent(url)}&via=dlsondoalumni`, '_blank');
                }}
              ...
              <button
                onClick={() => {
                  const subject = "DLSO Reunion Story: One Photo, Endless Joy";
                  const body = `I thought you'd enjoy this heartwarming story about our DLSO family reunion: ${window.location.href}`;
            ...
            <div className="mt-8 pt-6 border-t border-gray-200">
              <h4 className="text-lg font-semibold mb-4">Follow & Contact DLSO Alumni</h4>
